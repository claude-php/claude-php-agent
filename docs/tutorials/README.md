...
7. **[Dialog Agent Tutorial](./DialogAgent_Tutorial.md)**
   - **Best for**: Multi-turn conversations and chatbots
   - **Learn**: Session management, context tracking, conversation flow
   - **Time**: 40 minutes
   - **Difficulty**: Beginner

8. **[Intent Classifier Agent Tutorial](./IntentClassifierAgent_Tutorial.md)**
...
1. ✅ [Adaptive Agent Service](./AdaptiveAgentService_Tutorial.md) - Start here!
2. ✅ [Dialog Agent](./DialogAgent_Tutorial.md) - Build a chatbot
3. ✅ [Intent Classifier](./IntentClassifierAgent_Tutorial.md) - Add routing
...
1. ✅ [Chain of Thought](./ChainOfThoughtAgent_Tutorial.md) - Step-by-step reasoning
2. ✅ [Autonomous Agent](./AutonomousAgent_Tutorial.md) - Goal-oriented behavior
3. ✅ [Task Prioritization](./TaskPrioritizationAgent_Tutorial.md) - Dynamic planning
...
1. ✅ [Adaptive Agent Service](./AdaptiveAgentService_Tutorial.md) - Quality assurance
2. ✅ [Alert Agent](./AlertAgent_Tutorial.md) - Monitoring and notifications
3. ✅ [Coordinator Agent](./CoordinatorAgent_Tutorial.md) - Multi-agent orchestration
...
1. ✅ [Hierarchical Agent](./HierarchicalAgent_Tutorial.md) - Master-worker pattern
2. ✅ [Coordinator Agent](./CoordinatorAgent_Tutorial.md) - Load balancing
3. ✅ [Adaptive Agent Service](./AdaptiveAgentService_Tutorial.md) - Intelligent selection
...
1. ✅ [Learning Agent](./LearningAgent_Tutorial.md) - Experience-based improvement
2. ✅ [Adaptive Agent Service](./AdaptiveAgentService_Tutorial.md) - Performance tracking
3. ✅ [Environment Simulator](./EnvironmentSimulatorAgent_Tutorial.md) - Prediction
...
|----------|---------------------|------------|
| **Don't know which agent to use** | [Adaptive Agent Service](./AdaptiveAgentService_Tutorial.md) | Beginner |
| **Build a chatbot** | [Dialog Agent](./DialogAgent_Tutorial.md) | Beginner |
| **Route user requests** | [Intent Classifier](./IntentClassifierAgent_Tutorial.md) | Beginner |
| **Step-by-step reasoning** | [Chain of Thought](./ChainOfThoughtAgent_Tutorial.md) | Beginner |
| **Quality-critical content** | [Adaptive Agent Service](./AdaptiveAgentService_Tutorial.md) | Beginner |
| **Multi-domain tasks** | [Hierarchical Agent](./HierarchicalAgent_Tutorial.md) | Intermediate |
| **Long-running projects** | [Autonomous Agent](./AutonomousAgent_Tutorial.md) | Intermediate |
| **Monitoring & alerts** | [Alert Agent](./AlertAgent_Tutorial.md) | Intermediate |
| **What-if analysis** | [Environment Simulator](./EnvironmentSimulatorAgent_Tutorial.md) | Intermediate |
...
If you're unsure where to begin, start with the **[Adaptive Agent Service Tutorial](./AdaptiveAgentService_Tutorial.md)**. It:
...
- [API Reference](../adaptive-agent-service.md)
...
**Week 1**: Beginner tutorials (3 hours)
**Week 2**: Intermediate tutorials (3 hours)
**Week 3**: Advanced tutorials (3 hours)
**Week 4**: Build your own project (6 hours)
...
**Recommended First Step**: [Adaptive Agent Service Tutorial](./AdaptiveAgentService_Tutorial.md)
